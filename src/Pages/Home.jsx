  ...
  return (
    <main className="bg-[#100c1c] font-inter text-gray-300 overflow-x-hidden relative min-h-screen">
      ...
      <div className="relative z-10">
        {/* HERO SECTION */}
        <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 w-full">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              
              {/* Intro Text */}
              <div className="flex flex-col gap-6 lg:gap-8 text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-gray-400">Hello, I am</h2>
                  ...
                  <div className="h-8 sm:h-10 w-full max-w-xs overflow-hidden">
                    <div className="animate-infinite-scroll">
                      {roles.map((role, index) => (
                        <p key={index} className="h-8 sm:h-10 flex items-center bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-purple-400">
                          {role}
                        </p>
                      ))}
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 pt-4">
                  <button className="aurora-button w-full sm:w-auto flex items-center justify-center gap-2">
                    Learn More <ArrowRightIcon className="w-5 h-5"/>
                  </button>
                  <button className="aurora-button-secondary w-full sm:w-auto flex items-center justify-center gap-2">
        ...
        {/* ABOUT SECTION */}
        <section id="about" className="min-h-screen flex items-center justify-center py-16 lg:py-24 px-4 sm:px-6 w-full">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="relative flex justify-center items-center group">
                ...
                <div className="relative w-[220px] h-[300px] sm:w-[260px] sm:h-[360px] md:w-[300px] md:h-[400px] rounded-2xl overflow-hidden shadow-2xl transition-all duration-500 group-hover:scale-105 aurora-border">
                  <img src={dp} alt="Profile pic of Mrinmay Das" className="w-full h-full object-cover"/>
                </div>
              </div>
              ...
              <div className="space-y-6 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl p-6 md:p-8 shadow-lg">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white">
                  About <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#3bd6b2] to-[#2ebbdb]">Me</span>
                </h2>
                <div className="space-y-3 text-gray-300 text-base md:text-lg">
                  <p>
                    Hi! 👋 My name is <span className="font-semibold text-[#4f96de]">Mrinmay Das</span>. I am a UX/UI Designer based in Hanoi, Vietnam with experience through projects and subjects in university.
                  </p>
                  <p>
                    <span className="font-semibold text-white">My Objective:</span> To challenge myself in a new environment to learn, develop, and improve my skills through different projects, and contribute more to the company with my abilities.
                  </p>
                </div>
              </div>
